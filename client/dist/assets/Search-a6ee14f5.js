...
</div>`})})]}),r("div",{className:"panel",children:[r("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Overlay"}),e("button",{onClick:()=>{d("code2")},className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",children:r("span",{className:"flex items-center",children:[e(C,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5 space-y-5",children:e("form",{children:e(I,{onClickAway:w,children:r("div",{className:"search-form-overlay relative border border-white-dark/20 rounded-md h-12 w-full",onClick:p,children:[e("input",{type:"text",placeholder:"Search...",className:`form-input bg-white h-full placeholder:tracking-wider hidden ltr:pl-12 rtl:pr-12 peer ${m?"!block":""}`}),e("button",{type:"button",className:`text-dark/70 absolute ltr:right-1 rtl:left-1 inset-y-0 my-auto w-9 h-9 p-0 flex items-center justify-center peer-focus:text-primary ${m?"!ltr:!right-auto ltr:left-1 rtl:right-1":""}`,children:e(_,{className:"mx-auto w-5 h-5"})})]})})})}),a.includes("code2")&&e(k,{children:e("pre",{children:`import { useState} from 'react';
...
</form>`})})]}),r("div",{className:"panel",children:[r("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Search Box"}),e("button",{onClick:()=>{d("code3")},className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",children:r("span",{className:"flex items-center",children:[e(C,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5 space-y-5",children:e("form",{children:r("div",{className:"relative border border-white-dark/20  w-full flex",children:[e("button",{type:"submit",placeholder:"Let's find your question in fast way",className:"text-primary m-auto p-3 flex items-center justify-center",children:e(_,{className:"mx-auto w-5 h-5"})}),e("input",{type:"text",placeholder:"Let's find your question in fast way",className:"form-input border-0 border-l rounded-none bg-white  focus:shadow-[0_0_5px_2px_rgb(194_213_255_/_62%)] dark:shadow-[#1b2e4b] placeholder:tracking-wider focus:outline-none py-3"})]})})}),a.includes("code3")&&e(k,{children:e("pre",{children:`import { useState} from 'react';
