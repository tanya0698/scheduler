        ...
        <div>
            ...
            <div className="pt-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6 text-white">
                    <div className="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold">Created Appointments</div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    <div className="grid gap-6 xl:grid-flow-row">
                        ...
                        <div className="panel overflow-hidden">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-lg font-bold">Previous Appointments</div>
                            ...
                            <div className="relative mt-10">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <div className="mt-2 font-semibold text-2xl">30</div>
                                    </div>
                                    <div>
                                        <div className="text-primary">Work</div>
                                        <div className="mt-2 font-semibold text-2xl">20</div>
                                    </div>
                                    <div>
                                        <div className="text-primary">Traveling</div>
                                        <div className="mt-2 font-semibold text-2xl">5</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="panel overflow-hidden">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-lg font-bold">Current Appointments</div>
                            ...
                            <div className="relative mt-10">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        <div className="text-primary">Work</div>
                                        <div className="mt-2 font-semibold text-2xl">4</div>
                                    </div>
                                    <div>
                                        <div className="text-primary">Traveling</div>
                                        <div className="mt-2 font-semibold text-2xl">1</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {/*  Recent Transactions  */}
                    <div className="panel">
                        <div className="mb-5 text-lg font-bold">Pending Appointments</div>
